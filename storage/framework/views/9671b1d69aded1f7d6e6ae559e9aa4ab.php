...
<head>
  ...
  <style>
     body {
      ...
      text-align: center;
      background: url('<?php echo e(asset('assets/amis1.jpg')); ?>') center/cover;
    }
...
<header>
  ...
  <div id="partidoProgramado">
    ...
    <div class="equipo">
      <img src="<?php echo e(asset('assets/e1.jpg')); ?>" alt="Equipo 1">
      <p>Nombre Equipo 1</p>
    ...
    <div class="vs">VS</div>
    <div class="equipo">
      <img src="<?php echo e(asset('assets/e2.jpg')); ?>" alt="Equipo 2">
      <p>Nombre Equipo 2</p>
      <p>Capitán: Nombre Random</p>
      <p>Comuna: Santiago</p>
    </div>
...
<?php /**PATH C:\laragon\www\Futgool2\resources\views/amistoso.blade.php ENDPATH**/ ?>