...
<head>
    ...
    <style>
        body {
            ...
            background: url('<?php echo e(asset('assets/cru.jpg')); ?>') center/cover;
            color: #000;
        }
...
<body>
    ...
    <form id="registroForm" action="<?php echo e(route('registro.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Futgool2\resources\views/registrojugador.blade.php ENDPATH**/ ?>